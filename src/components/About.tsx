  ...
  return (
    <section className="w-full lg:h-[900px] h-auto grid grid-cols-1 lg:grid-cols-2 border-b border-black text-[#242424] bg-white">
      ...
      <div className="flex flex-col justify-between p-[64px] border-b lg:border-b-0 lg:border-r border-black">
        ...
        {/* Bagian Atas (Teks) */}
        <div>
          <h3 className="font-mono text-[13px] uppercase leading-[1.4] mb-[32px]">
            ABOUT ME
          </h3>
          <h2 className="font-sans text-5xl lg:text-[80px] font-normal leading-[1.1]">
        ...
        <div>
          <p className="font-sans text-[18px] leading-[1.8]">
