    ...
    <section className="w-full flex flex-col bg-white">
      ...
      <div className="w-full h-auto lg:h-[600px] p-4 lg:p-[64px] flex flex-col lg:flex-row justify-between items-start lg:items-center border-t border-b border-black">
        ...
        <div className="flex flex-col max-w-[800px] mt-12 lg:mt-0 mb-12 lg:mb-0">
          ...
          <h2 className="font-sans text-5xl lg:text-[96px] font-normal leading-[1.1] tracking-tighter text-[#242424]">
            Let’s bring your brand<br />to the next level
          </h2>
        </div>

        {/* Right Side - Button */}
        <button className="w-[158px] h-[51px] bg-[#242424] text-white flex items-center justify-center font-mono text-[13px] uppercase border border-black hover:bg-white hover:text-[#242424] transition-colors gap-1 shrink-0">
